 ...
 * @endcode
 */
$settings['hash_salt'] = 'AFpqKv-H9BomPTFsI068so94KDdVMZq9KVq9gN3S_GkE9cSuFfA_meoZ49aULu4HbomaLlZ5Gw';
 ...
 */
# $settings['file_public_path'] = 'sites/avinuty.ac.in/files';

 $settings['file_public_path'] = 'sites/20.244.108.73/files';
...
$settings['config_sync_directory'] = 'sites/20.244.108.73/files/config_tkeW0E2vOTrn8Cm1tCqZ6PomJbBvdvDpGeWoBRT1S3wPsjgHNAtj5mAisRvXFoVnzu32afwXyg/sync';
$config['system.logging']['error_level'] = 'verbose';
